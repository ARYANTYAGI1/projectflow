...
const { addProject, updateProject, changeStatus, getProjectDetail, getProjectList, getProjects, getProjectMembers } = require('../controllers/ProjectController');
...
router.get('/project-members/:id', protect, getProjectMembers)
